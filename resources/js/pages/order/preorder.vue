...
const status_id = ref(props.append?.status_id)
                ...
                <div class="border rounded-b-md px-2 py-1 min-h-[calc(100vh-13rem)]">
                    <table class="table-fixed w-full">
                       <tr class="bg-gray-400">
                            ...
                            <tr v-for="(order, index) in Object.values(orders?.data)" class="bg-gray-100 even:bg-white cursor-pointer hover:bg-gray-300" :class="colorClassMap[order.status.id]">
