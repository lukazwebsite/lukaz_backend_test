...
const submit = () => {
    ...
    router.get(currentUrl.value, filters, {
        preserveState: true,
        replace: true,
...
const goToPage = () => {
    ...
    router.get('/orders/'+props.filter_status+'/show/?page=' + pageNumber.value, {}, {
        headers: {
                    ...
                    <table class="table-fixed w-full">
                       <tr class="bg-gray-400">
                            ...
                            <tr v-for="(order, index) in Object.values(orders?.data)" class="bg-gray-100 even:bg-white cursor-pointer hover:bg-gray-300" :key="index" :class="colorClassMap[order.status.id]">
                                ...
                                <td class="text-center">{{ order?.order_type == 1 ? "Regular" : "Pre-order" }}</td>
