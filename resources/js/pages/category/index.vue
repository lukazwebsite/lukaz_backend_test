...
onMounted(() => {
    ...
    const pageNumber = ref(props.categories?.current_page);
...
const visibleRight = ref(false);
    ...
    const submit = () => {
        ...
        router.post('/categories/paginate/filters', formData, {
            headers: {
    ...
    const goToPage = () => {
        ...
        router.get('/categories?page=' + pageNumber.value, {}, {
            headers: {
                Accept: 'application/json',
                'X-Requested-With': 'XMLHttpRequest',
            },
        ...
        <div class="w-full mx-auto p-2 flex flex-row place-content-center">
            <div className="w-5/6 mt-4 shadow-lg bg-white rounded-md pb-1">
                <div class="flex justify-between bg-gray-300 px-2 py-1 items-center rounded-t-md">
                    <div class="text-lg font-semibold">Categories List</div>
                    <div class="flex">
                        ...
                        <Link v-if="add?.action_id || checkPermission" href="/categories/create" class="bg-green-600 p-2 rounded-r-md text-lg px-3 flex text-white">
                            <Icon icon="fluent:add-12-filled" class="mr-2" width="1.5rem" height="1.5erm"/> Add Categories </Link>
                    </div>
                </div>
                    ...
                    <div class="w-full border-t mt-4">
                        <table class="w-full">
                            <thead>
                                ...
                                <Category :categories="categories?.data" :edit="edit" :checkPermission="checkPermission"/>
                    ...
                    <form @submit.prevent="submit">
                        <div class="grid grid-col-1 mt-4">
                            ...
                            <div class="card w-full justify-center mt-2">
                                <label for="dd-city" class="text-md w-full content-center font-semibold">Category Name</label>
