<script setup lang="ts">
    ...
    const submit = () => {
        ...
        router.post('/role/'+id.value, formData, {
            headers: {
                ...
                <form @submit.prevent="submit" class="px-3 h-[calc(100vh-10rem)] justify-items-center mt-2">
                    ...
                    <div class="w-1/2 shadow-sm rounded-md border-t p-2 px-4">
                        ...
                        <div class="w-full mb-1 grid grid-flow-col justify-items-end mt-2">
                            <button class="justify-items-end cursor-pointer bg-orange-500 hover:bg-orange-600 text-md border py-1 px-2 rounded-md font-semibold text-white">Update Role</button>
                        </div>
                    </div>
