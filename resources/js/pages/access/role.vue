<script setup lang="ts">
    ...
    const getUserPermission = (e) => {
        ...
        roleId.value  = e.value.id;

        axios.get(`/role_access/${e.value.id}/edit`)
        .then(res => {
    ...
    const search = (event) => {
        ...
        items.value = props.roles.filter(p => p.name.toLowerCase().includes(query));
    ...
    const submit = () => {
        ...
        router.post(`/role_access/${roleId.value}/edit`, formData, {
            forceFormData: true,
            onSuccess: () => {
        ...
        <div class="w-full mx-auto p-2 flex flex-row place-content-center">
            <div className="w-5/6 mt-4 shadow-lg bg-white rounded-md pb-1">
                ...
                <div class="flex justify-between bg-gray-300 px-2 items-center rounded-t-md p-1 ">
                    <div class="text-lg font-semibold">Role Permission</div>
                    <div class="flex">
                    ...
                    <form @submit.prevent="submit" class="w-2/3">
                        <div class="w-full shadow-sm rounded-md border-t p-2 px-4 overflow-auto">
                            ...
                            <div class="w-full flex flex-col mb-4">
                                <label :class="{'text-red-500': errors?.name }" for="dd-city" class="text-md font-semibold w-full content-center"> All Roles:</label>
                ...
                <div class="w-full mb-1 mt-2 px-4 flex justify-center">
                    <div class="w-2/3 justify-items-end grid grid-flow-col">
                        ...
                        <div class="text-black"><input type="checkbox" v-model="exits" /> It will effect on exting role</div>
