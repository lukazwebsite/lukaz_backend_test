<script setup lang="ts">
    ...
    const submit = () => {
        ...
        router.get('/report/stock/extra', filters, {
            preserveState: true,
            replace: true,
    ...
    const goToPage = () => {
        ...
        router.get('/report/stock/extra?page=' + pageNumber.value, {}, {
            headers: {
            ...
            <div class="w-5/6 mt-4 shadow-lg bg-white rounded-md">
                <div class="flex justify-between bg-gray-300 px-2 py-1 items-center rounded-t-md">
                    ...
                    <div class="flex">
                        ...
                        <a v-if="queryString != ''" :href="`/report/stock/exports/extra${queryString.replace(/^\?/, '?')}`" class="bg-green-600 items-center p-2 flex px-4 rounded-l-md cursor-pointer">
