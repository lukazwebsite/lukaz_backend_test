...
const submit = () => {
    ...
    router.get('/reports/extra', filters, {
        preserveState: true,
        replace: true,
...
const goToPage = () => {
    ...
    router.get('/reports/extra?page=' + pageNumber.value, {}, {
        headers: {
        ...
        <div class="w-full mx-auto p-2 flex flex-row place-content-center">
            <div class="w-5/6 mt-4 shadow-lg bg-white rounded-md">
                <div class="flex justify-between bg-gray-300 px-2 py-1 items-center rounded-t-md">
                    ...
                    <div class="flex">
                        <a v-if="queryString != ''" :href="`/reports/extra${queryString.replace(/^\?/, '?')}&excel=download`" class="bg-green-600 items-center p-2 flex px-4 rounded-l-md cursor-pointer">
