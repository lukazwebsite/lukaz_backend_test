...
const submit = () => {
    ...
    router.get('/offline/paginate/filters/extra', filters, {
        preserveState: true,
        replace: true,
...
const goToPage = () => {
    ...
    router.get('/offline/extra?page=' + pageNumber.value, {}, {
        headers: {
                    ...
                    <table class="table-fixed w-full">
                       <tr class="bg-gray-400">
                            ...
                            <tr v-for="(order, index) in Object.values(orders?.data)" class="bg-gray-100 even:bg-white cursor-pointer hover:bg-gray-300" :class="colorClassMap[order.status.id]" :key="order?.id">
                                ...
                                <td>
                                    <Link :href="`/orders/${order.order_no}/view`" class="hover:text-blue-700 text-blue-400">{{ order?.order_no }}</Link>
                                    <br/>
