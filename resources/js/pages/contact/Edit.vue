...
const submit = () => {
    ...
    router.post('/contact/' + contactId?.value, formData, {
        headers: {
        ...
        forceFormData: true,
        onSuccess: () => {
            toast.add({ severity: 'success', summary: 'Success Message', detail: 'Contacts store successfully!', life: 3000 });
            errors.value = {};
            loading.value = false;
        },
        onError: (e) => {
        ...
        <div class="w-full mx-auto p-2 flex flex-row place-content-center">
            <div className="w-5/6 mt-4 shadow-lg bg-white rounded-md pb-1">
                ...
                <div class="flex justify-between bg-gray-300 px-2 items-center rounded-t-md p-1 ">
                    <div class="text-lg font-semibold">Edit Contact</div>
                    <div class="flex">
                        <Link href="/contact"
                    ...
                    <div class="w-3/4 rounded-md  p-2 px-4 grid grid-cols-2 gap-2">
                        ...
                        <div class="w-full mb-1">
                            ...
                            <input :class="{ 'border': true, 'border-red-500 text-red-500': errors?.name }" type="text"
                                ...
                                placeholder="Contacts Title" readonly />
                        ...
                        <div class="w-full mb-1">
                            <label for="dd-city" class="text-md font-semibold w-full content-center">Phone:</label>
                        ...
                        <div class="w-full mb-1">
                           ...
                           <div class="grid mb-1 col-span-2">
                            <label for="dd-city"
                                class="text-md font-semibold w-full content-center">message:</label>
                            <textarea v-model="message"
                                class="w-full text-md border py-1 px-2 outline-none focus:border-green-200 rounded-md" readonly></textarea>
                        </div>
