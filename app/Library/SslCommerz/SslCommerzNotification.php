...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function makePayment(array $requestData, $type = 'checkout', $pattern = 'json')
    {
        ...
        $post_data['cus_name'] = $requestData['shipping_info']['full_name'] ?? '';
        $post_data['cus_email'] = $requestData['shipping_info']['phone'] . '@mail.com';
        $post_data['cus_add1'] = $requestData['shipping_info']['address'] ?? 'Customer Address';
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = $requestData['shipping_info']['thana'] ?? '';
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $requestData['shipping_info']['phone'] ?? '8801XXXXXXXXX';
        $post_data['cus_fax'] = "";
        ...
        $requestData = array_merge($post_data, $requestData);
    ...
    {
        $this->successUrl = rtrim(env('APP_FRONTED_URL'), '/') . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim(env('APP_FRONTED_URL'), '/') . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = rtrim(env('APP_FRONTED_URL'), '/') . $this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim(env('APP_FRONTED_URL'), '/') . $this->config['ipn_url'];
    }
