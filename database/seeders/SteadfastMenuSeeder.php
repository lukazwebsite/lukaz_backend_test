...
class SteadfastMenuSeeder extends Seeder
{
    /**
     * Add the Steadfast sidebar link and its View/Add/Edit/Delete actions.
     *
    ...
    public function run()
    {
        $existing = DB::table('menus')->where('href', '/steadfast')->value('id');
